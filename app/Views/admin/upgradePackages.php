...
<main class="page-content">
    <div class="pagenav">
        ...
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#packageModal">Add New</button>
    </div>
    <hr />
    <div class="card">
        <div class="card-body">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= esc($packageData[$package['upgrade_from']]['name']) ?></td>
                            <td><?= esc($packageData[$package['upgrade_to']]['name']) ?></td>
                            <td><?= esc($package['price']) ?></td>
                            <td><a href="<?= base_url(env('app.adminURL') . '/upgrade-package/' . esc($package['id'])) ?>"><button class="btn btn-primary">View</button></a></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="packageModalLabel">Add New Upgrade Package</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url(env('app.adminURL') . '/new-upgrade-package') ?>" method="POST" class="row g-3">
                    <?= csrf_field() ?>
                    <div class="col-12">
                        <label for="upgrade_from" class="form-label">Upgrade From</label>
                    ...
                    <div class="col-12">
                        <input type="submit" class="btn btn-primary" value="Add Upgrade Package">
                    </div>
                </form>
            </div>
        </div>
